...
function mountProbeklausuren(container, baseUrl) {
  const klausuren = [
    { label: 'Probeklausur 1', file: 'Probeklausur_FiBu_1.html' },
    { label: 'Probeklausur 2', file: 'Probeklausur_FiBu_2.html' },
    { label: 'Probeklausur 3', file: 'Probeklausur_FiBu_3.html' },
    { label: 'Probeklausur 4', file: 'Probeklausur_FiBu_4.html' },
  ]
  const downloadsBase = `${baseUrl}downloads/fibu/`
